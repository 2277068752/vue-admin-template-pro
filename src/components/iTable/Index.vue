...
<template>
  <div class="table">
    <el-table id="iTable" v-loading.iTable="loading" :data="list" :max-height="height" border
      ...
      <!--endregion-->
      <!--region 数据列-->
      <el-table-column v-for="(column, index) in columns" :key="index" v-if="!column.hidden" :prop="column.prop"
                       :label="column.label"
                       :align="column.align"
                       :width="column.width"
        ...
        <template slot-scope="scope">
          <div class="operate-group">
            <template v-for="(btn, key) in operates.list">
              <div class="item" :key="key" v-if="!btn.show || btn.show(scope.$index,scope.row)">
                <el-button :type="btn.type" size="mini" :icon="btn.icon"
                           :disabled="btn.disabled&&btn.disabled(scope.$index,scope.row)" :plain="btn.plain"
